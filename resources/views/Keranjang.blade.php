	...
	<section id="cart_items">
		<div class="container">
			<div class="breadcrumbs">
				<ol class="breadcrumb">
				  <li><a href="/BahanStudy/#">Home</a></li>
					...
					<tbody>
						...
						<tr>
							<td class="cart_product">
								<a href="/BahanStudy/"><img src="/data_file/{{$krj->gambar}}" alt=""></a>
							</td>
							<td class="cart_description">
								<h4><a href="/BahanStudy/">{{$krj->nama_produk}}</a></h4>
							</td>
							<td class="cart_price">
								<p>Rp. {{$krj->harga}}</p>
							</td>
							...
							<td class="cart_delete">
								<a class="cart_quantity_delete" href="/hapusKeranjang"><i class="fa fa-times"></i></a>
							</td>
		...
		<div class="footer-bottom">
			<div class="container">
				<div class="row">
					...
					<p class="pull-right">Designed by <span><a target="_blank" href="/BahanStudy/http://www.themeum.com">Themeum</a></span></p>
				</div>
			</div>
		</div>
